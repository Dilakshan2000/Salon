...
import { IoMdAddCircleOutline } from 'react-icons/io'; // Importing the icon
...
const handleSubmit = async (e) => {
    ...
    const handleOrderClick = (supplierId) => {
        navigate(`/sup-orders/${supplierId}`);
    };
    ...
    const handleDownloadReport = () => {
        ...
        const title = ""; 
        const columns = ["first_name", "last_name", "mobile_number", "email", "sup_category", "Downloaded At"];
        
        const fileName = "supplier_report";
        const formattedData = filterUsers.map(user => ({
            ...user,
